...
namespace Nodindow.myPackages
{
    public class TreeViewAdvanced : TreeView
    {
        ...
        public class TreeNodeAdvanced
        {
            ...
            #region comment
            /// <summary>
            /// used to store information that will be consulted and stored
            /// </summary>
            /// <param name="text">text to be displayed on the node</param>
            /// <param name="name">node name</param>
            /// <param name="userObject">object that the user wants to store within the node</param>
            /// <param name="treeNode">TreeNode that is associated with TreeNodeAdvanced</param>
            /// <param name="icon">node icon</param>
            /// <param name="treeNodeAdvancedParent">previous node</param>
            /// <param name="treeNodeAdvancedChildrens">children of TreeNodeAdvanced</param>
            /// <param name="locked">blocks node deletion</param>
            #endregion
            [JsonConstructor]
        ...
        public class TreeNodeAdvancedIcons
        {
            ...
            public class iconAdvanced
            {
                ...
                public iconAdvanced(string name, string iconPath = null)
                {
                    this.name = name;
